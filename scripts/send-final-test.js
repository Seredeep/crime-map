...
// Mensaje con formato final usando tabs para sangrías
const finalMessage = `🚨 CITIZEN SECURITY SYSTEM - ZACAGNINI JOSE MANUEL
...
async function sendFinalTestMessage(chatId = 'chat_zacagnini_jose_manuel') {
  try {
    console.log(`📤 Sending final test message to chat: ${chatId}`);
    console.log('==========================================');
    ...
    console.log('✅ Final test message sent successfully');
    console.log(`💬 Chat: ${chatId}`);
    console.log(`👤 User: ${userData.name}`);
    console.log(`📝 Message length: ${finalMessage.length} characters`);
    console.log('🎨 Message uses tabs for proper indentation');
