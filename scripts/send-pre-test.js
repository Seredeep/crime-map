...
async function sendPreTestMessage(chatId = 'chat_zacagnini_jose_manuel') {
  try {
    console.log(`📤 Sending pre test message to chat: ${chatId}`);
    console.log('==========================================');
    ...
    console.log('✅ Pre test message sent successfully');
    console.log(`💬 Chat: ${chatId}`);
    console.log(`👤 User: ${userData.name}`);
    console.log(`📝 Message length: ${testMessage.length} characters`);
    console.log('🎨 Message uses <pre> tag with whitespace-pre-wrap');
