// scripts/send-formatted-test.js
...
// Mensaje con formato mejorado que debería funcionar con el sistema de formateo
const formattedMessage = `🚨 CITIZEN SECURITY SYSTEM - ZACAGNINI JOSE MANUEL
...
async function sendFormattedTestMessage(chatId = 'chat_zacagnini_jose_manuel') {
  try {
    console.log(`📤 Sending formatted test message to chat: ${chatId}`);
    console.log('==========================================');
    ...
    await firestore.collection('chats').doc(chatId).update({
      lastMessage: formattedMessage.substring(0, 100) + '...',
    ...
    console.log('🎨 Message includes proper indentation for lists and sections');
