...
interface MobileExploreCommunitiesViewProps {
  className?: string;
}

const MobileExploreCommunitiesView = ({ className = '' }: MobileExploreCommunitiesViewProps) => {
    ...
    <div className={`w-full h-full bg-gray-900 ${className}`}>
      ...
      <div className="sticky top-0 z-10 bg-gray-900/95 backdrop-blur-sm border-b border-gray-700/50 p-4">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-2xl font-bold text-white">Explorar Comunidades</h1>
...
export default MobileExploreCommunitiesView;
