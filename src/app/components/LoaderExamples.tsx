  ...
  <div className="flex flex-col items-center justify-center py-8">
    ...
    >
      <motion.div
        ...
        className="absolute inset-0 w-16 h-16 border-2 border-t-blue-500 border-r-blue-400 border-transparent rounded-full"
      />
      <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center shadow-xl">
        <FiAlertTriangle className="w-8 h-8 text-white" />
      </div>
    </motion.div>
    <div className="text-lg font-semibold text-blue-200 mb-2">{message}</div>
  ...
  <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-gray-900/80 backdrop-blur-sm">
    ...
    >
      <motion.div
        ...
        className="absolute inset-0 w-20 h-20 border-2 border-t-cyan-400 border-r-blue-400 border-transparent rounded-full"
      />
    ...
    <div className="flex space-x-2 mt-2">
      {[0, 1, 2].map(i => (
        <motion.div
          ...
          className="w-4 h-4 bg-cyan-400 rounded-full shadow"
        />
      ))}
    </div>
  </div>
