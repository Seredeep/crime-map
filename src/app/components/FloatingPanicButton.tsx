...
const FloatingPanicButton = ({ onClick, isVisible = true }: FloatingPanicButtonProps) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Icono principal */}
          <FiAlertTriangle className="w-12 h-12 text-orange-500 group-hover:text-orange-600 transition-colors stroke-[2.5]" />
          ...
          <motion.p
            ...
            className="absolute bottom-1 transform -translate-y-1/2 font-manrope text-[10px] font-semibold text-[#B5CCF4]"
          >
            Pánico
          </motion.p>
        </motion.button>
